...
function Neverlose_Main:Window(config)
    ...
    VersionText.Text = "Version: <font color='rgb(9, 174, 255)'>".."nothing (no lib)".."</font>"
    ...
    BuildDateText.Text = "Build date: <font color='rgb(9, 174, 255)'>".."nothing (no lib)".."</font>"
    ...
    BuildTypeText.Text = "Build type: <font color='rgb(9, 174, 255)'>".."nothing (no lib)".."</font>"
    ...
    NewsText.Text = "Latest News: <font color='rgb(9, 174, 255)'>".."nothing (no lib)".."</font>"
